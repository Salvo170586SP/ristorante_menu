...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-sm d-sm-block d-md-none mt-4">
            <a href="{{ route('admin.desserts.create') }}" class="btn btn-primary px-5 py-2 shadow mb-3 my-3 ">Crea</a>
        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h5>Sei sicuro di eliminare {{ $dessert->name }}?</h5>
                                </div>
        ...
        <div class="d-none col-md-12 d-md-block mt-5">
            <a href="{{ route('admin.desserts.create') }}" class="btn btn-primary shadow mb-3 px-5 py-2">Crea</a>
            <h6>Totale dei prodotti in tabella: {{ count($desserts) }}</h6>
