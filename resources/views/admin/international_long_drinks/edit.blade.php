...
<div class="container">
    <div class="row">
        <div class="col-12 d-flex justify-content-between align-items-center py-5">
            <h1 class="text-3xl my-9">Modifica International Long Drink</h1>
        ...
        <div class="col-12">
            ...
            <form action="{{ route('admin.international_long_drinks.update', $internationalLongDrink->id) }}" method="post" class="mt-5">
                @csrf
                @method('put')
