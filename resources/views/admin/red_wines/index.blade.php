        ...
        <div class="col-sm d-sm-block d-md-none my-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.red_wines.show', $red_wine->id) }}" class="btn btn-primary">Vedi</a>
                    <a href="{{ route('admin.red_wines.edit', $red_wine->id) }}" class="btn btn-secondary mx-2">Modifica</a>
